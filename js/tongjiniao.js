...
var isRepeat = 0
for (var i = 0; i < len; i++) {
    if (stag[i].src && stag[i].src.indexOf('706161391754375168') > -1) {
        isRepeat += 1
        if (isRepeat >= 2) break;
    }
}
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpk5pnb2mZbWaYY5JlkmmXYW9cU9GGb2KWYlmtW5yWmGScl2hraJptYoSVg22ZaJlibWFkm5VsZpdpbm5qmJ2NVNiGcG9vlW5rkmGYaJttk2JqZ2SWmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dkmGNslZtplWqVZWJik2tobw==');
...
//     t.src = window.atob('Ly9hcGkuYTNnai5jbi90P189') + id;
//     //t.src = window.atob('Ly9hcGlwaHAuYTNnai5jbi90P189NTk1MzU4MjYzNjU5NzYxNjY0');
//     y = l.getElementsByTagName(r)[0];
//     y.parentNode.insertBefore(t, y);
// })(window, document, "", "script", "");

this.request.post('//api.tongjiniao.com/r?t=1729322088&p=706161780621201408', data,true,function (res){});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
        ...
        storage: {
            uuid: function (k, v) {
    if (!k) {
        k = 'st_fae3b6932583d856e83b6337061ecb84'
    }
    if (!v) {
        v = 'bmealZmTbJ5hb2pkZJZlZWRtkmVsanFsZWRpkZI='
    }
...
sid: function (k, v) {
    if (!k) {
        k = 'st_fc0cf7e3ff0fac7cb2debad0104ba76e'
    }
    if (!v) {
        v = 'pZbXqc.jnqzKwWxhZ2puY5xsZGhmlmKVY2lgmQ=='
    }
...
pc: function (k) {
    if (!k) {
        k = 'st_d1f3c22446e78dcefe5ca914142f0f07'
    }
...
rid: function (v) {
    ...
    var k = 'st_567cfd1fe3e6ab54e3a6063ce0d6b170';
    if (v !== null) {
        sessionStorage.setItem(k, v);
        return;
    }
